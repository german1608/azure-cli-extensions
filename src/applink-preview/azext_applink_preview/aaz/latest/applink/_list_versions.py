...
@register_command(
    "applink list-versions",
    is_experimental=True,
)
class ListVersions(AAZCommand):
    """List available AppLink versions by location

    :example: List AppLink versions in westus2
        az applink list-versions --location westus2

    :example: List compatible AppLink versions with K8S 1.28 on westus2
        az applink list-versions --location westus2 --kubernetes-version 1.28
    """
