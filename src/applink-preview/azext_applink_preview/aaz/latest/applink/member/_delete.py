...
class Delete(AAZCommand):
    ...
    :example: Delete an AppLink member
        az applink member delete --resource-group test_rg --applink-name applink-test-01 --member-name member-01
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.AppLinkMembersDelete(ctx=self.ctx)()
    ...
    class AppLinkMembersDelete(AAZHttpOperation):
