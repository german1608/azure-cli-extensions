...
@register_command(
    "applink member upgrade-history list",
    is_experimental=True,
)
class List(AAZCommand):
    """List the upgrade history of an AppLink member

    :example: List upgrade history of an AppLink member
        az applink member upgrade-history list --resource-group test_rg --applink-name applink-test-01 --member-name member-01
    """

    _aaz_info = {
        "version": "2025-04-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.applink/applinks/{}/applinkmembers/{}/upgradehistories", "2025-04-01-preview"],
        ]
    }
    ...
    class UpgradeHistoriesListByAppLinkMember(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Private.CloudAppLink/appLinks/{appLinkName}/appLinkMembers/{appLinkMemberName}/upgradeHistories",
                **self.url_parameters
            )
