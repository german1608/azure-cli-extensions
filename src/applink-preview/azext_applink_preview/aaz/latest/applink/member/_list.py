...
class List(AAZCommand):
    ...
    :example: List members of an AppLink resource
        az applink member list --resource-group test_rg --applink-name applink-test-01
    """
    ...
    class AppLinkMembersListByAppLink(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            observability_settings = cls._schema_on_200.value.Element.properties.observability_settings
            ...
            logs = cls._schema_on_200.value.Element.properties.observability_settings.logs
            logs.state = AAZStrType(
                flags={"required": True},
            )

            metrics = cls._schema_on_200.value.Element.properties.observability_settings.metrics
            metrics.state = AAZStrType(
                flags={"required": True},
            )

            traces = cls._schema_on_200.value.Element.properties.observability_settings.traces
