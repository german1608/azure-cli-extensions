...
def applink_member_list_table_format(results):
    """Format applink member list results for display with "-o table"."""
    return [_applink_member_show_table_format(r) for r in results]


def _applink_member_show_table_format(result):
    """Format a single applink member as summary results for display with "-o table"."""
...
def applink_member_upgrade_history_table_format(results):
    """Format applink member upgrade history results for display with "-o table"."""
    formatted_results = []
    for result in results:
        parsed = compile_jmes("""{
            name: name,
